...
layout: page
title: Koko-X
description: Redesigning Koko, a startup that integrates mental health resources in pre-existing social media platforms to provide younger adults an easier access point to mental health care.
importance: 1
category: design
related_publications: false
---

Koko is a startup that **integrates mental health resources in pre-existing social media platforms to provide younger adults an easier access point to mental health care**.  They partner with online communities to help find and treat at-risk individuals directly on their platform using online interventions on Koko. Koko uses a keyword-trigger design system in which certain negative-thought-keywords will trigger the interface to open up resources for mental health. In this design process, we are creating a plug-in feature linked to a Koko mobile app. 
...
1. From the home page, tap **Explore your Feelings** [Success: Yes, No] [5-point Scale: Difficult to Easy]
2. On the Explore Your Feelings page, tap **Stressed** [Success: Yes, No] [5-point rating scale: Difficult to Easy]
3. When given activity options, tap **Try Coloring** [Success: Yes, No] [5-point Scale: Difficult to Easy]
4. This mock-up page is not functional, but talk through how you would use this page. [Success: Yes, No] [5-point rating scale: Difficult to Easy]
5. This mock-up page is not functional, but talk through how you would use this page. [Success: Yes, No] [5-point rating scale: Difficult to Easy]
6. Navigate to the **Emotional Support Animal** page. [Success: Yes, No] [5-point rating scale: Difficult to Easy]
7. Tap the screen and follow the directions to feed the cat sushi. [Success: Yes, No] [5-point rating scale: Difficult to Easy]
8. Tap the screen and follow the directions to feed the cat sushi. [Success: Yes, No] [5-point rating scale: Difficult to Easy]
9. Navigate to the **Talk to Someone** page. [Success: Yes, No] [5-point rating scale: Difficult to Easy]
10. This page is not fully functional, but talk through how you would use this page. [Success: Yes, No] [5-point rating scale: Difficult to Easy]
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/colortherapy.jpg" title="Color Therapy" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/sushicat.jpg" title="Animal Therapy" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/talktherapy.jpg" title="Talk Therapy" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
[Navigate your way back to my projects](https://zainabiftikhar.com/projects) ❤️
